<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
  <div class="container-fluid py-1 px-3">
    ...
    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
      ...
      <img src="../assets1/img/LOGO_ISNAKA.png" alt="" srcset="" width="50px">
      <h3> <a href="/main">Acceuil</a></h3>
    ...
    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
      ...
      @if(session('utilisateurs')->jres==1 and session('utilisateurs')->get==1 and session('utilisateurs')->gbda==1 and session('utilisateurs')->gpai==1 and session('utilisateurs')->gfac==1 and session('utilisateurs')->gpaie==1 and session('utilisateurs')->gfour==1) 
        <li  class="nav-item d-flex align-items-center"><a href="/register" class="btn btn-outline-primary btn-sm mb-0 me-3" target="">Creer compte</a></li>
      @endif
      <li class="nav-item d-flex align-items-center">
          <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="" href=""><span>{{ session('utilisateurs')->prenom }}</span>
            {{ session('utilisateurs')->nom }}</a>
        </li>
      
      </div>
      <ul class="navbar-nav  justify-content-end">
      <li class="nav-item d-flex align-items-center">
          <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="" href="/presence">Marquer votre présence</a>
        </li>
        <li class="nav-item d-flex align-items-center">
          <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="" href="{{route('profile')}}">Modifier votre mot de passe</a>
        </li>
        <li class="nav-item d-flex align-items-center">
          <a href="/out" class="nav-link text-body font-weight-bold px-0">

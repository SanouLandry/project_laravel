    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Configuration de votre boutique</h5>
          <p></p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">Informations sur la boutique</h6>
        </div>
        <div class="card-body">
                  <form role="form">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      <label class="form-label">Nom & prénom(s) du propriétaire</label>
                      <input type="text" class="form-control">
                    </div>
                    <div class="input-group input-group-outline mb-3">

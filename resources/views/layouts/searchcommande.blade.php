      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <div class="text-center">
            <form role="form" action="/search_commandes" method="post">
            {{ csrf_field() }}
              <div class="row">
                  <div class="col-6">
        ...
        <div class="row">
                  <div class="col-6">
                        <button type="button" class="btn btn-primary" style="text-align:center" ><a href="/getlist_commandes">Exporter</a></button>
                  </div> 
                 <!--  <div class="col-6">

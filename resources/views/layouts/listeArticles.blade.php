      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <div class="text-center">
            <form role="form" action="/search_articles" method="get">
              <div class="row">
                  <div class="col-6">
                  ...
                  <div class="col-2">
                         <button type="button" class="btn btn-lg bg-gradient-success" ><a href="/get_codebarre">Code Barre</a></button>
                  </div> 
              </div>
            </form>
              </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  @foreach($articles as $articlesData)
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{ $articlesData->libelleCategorie }}</h6>
                      ...
                      <td class="align-middle">
                        <a href="{{ 'edit_article/'.$articlesData->idArticle }}"class="badge badge-sm bg-gradient-warning" data-toggle="tooltip" data-original-title="Edit user">
                          Modifier
                        </a>
                        <a href="{{ 'del_article/'.$articlesData->idArticle }}"class="badge badge-sm bg-gradient-danger" data-toggle="tooltip" data-original-title="Edit user" onclick="return confirm('Etes vous sûr de vouloir supprimer?');">
                          Supprimer
                        </a>
                        <a href="{{ 'print_codebarre/'.$articlesData->idArticle }}"class="badge badge-sm bg-gradient-info" data-toggle="tooltip" data-original-title="Edit user">
                          Code Barre
                        </a>
                      </td>
                    </tr>
          ...
          <div class="row">
                  <div class="col-6">
                        <button type="button" class="btn btn-lg bg-gradient-success"><a href="/list_articles">Imprimer</a></button>
                  </div> 
                  <div class="col-6">
                         <button type="button" class="btn btn-lg bg-gradient-info"><a href="/liste_article">Exporter</a></button>
                  </div> 
              </div>   
        </div>
      </div>
